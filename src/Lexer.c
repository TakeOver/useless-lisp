...
static yyconst flex_int16_t yy_base[23] =
    {   0,
        0,    0,   20,   21,    0,    0,    0,    2,   21,   21,
       21,   21,    9,   21,    0,    0,   21,   21,    8,   21,
       15,   13
    } ;
...
YY_RULE_SETUP
#line 38 "lazy.l"
{ int c; while((c = yyinput(yyscanner))!=EOF && c && c!='\n'); }
	YY_BREAK
case 6:
